      ...
      {false ? (
        ...
        <View style={styles.container}>
          ...
          <View style={styles.cardView}>
            <View style={styles.flxRow}>
              <Text style={styles.head}>Name of the Faculty : </Text>
              <Text style={styles.subHead}>Sports</Text>
            </View>
            <View style={styles.flxRow}>
              <Text style={styles.head}>Selected Sport : </Text>
              <Text style={styles.subHead}>Cricket</Text>
            </View>
            <View style={styles.flxRow}>
              <Text style={styles.head}>Scheduled Time : </Text>
              <Text style={styles.subHead}>04 : 30 PM</Text>
            </View>
          </View>
